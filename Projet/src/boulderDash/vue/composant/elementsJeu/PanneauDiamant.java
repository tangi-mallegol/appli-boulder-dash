...
public class PanneauDiamant extends PanneauElementJeu implements Observer{
private JLabel[] TableauImage;
	
	public PanneauDiamant(){
		BufferedImage ii = null;
		try {
			ii = ImageIO.read(new File("./donnees/images/diamond.gif"));
	...
	public void Move(){
		...
		timer.schedule(new TimerTask(){
			int i = 0;
			public void run(){
				remove(TableauImage[i%8]);
				i++;
				add(TableauImage[i%8]);
				repaint();
			}
		}, 500,50);
	}
